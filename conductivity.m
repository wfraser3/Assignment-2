...
conduct = zeros(100,1);
scaleFactor = linspace(0.1,10,100);
for iter = 1:100
...
figure(1)
plot(conduct,meanCurrent,'b')
xlabel('Contact Conductivity')
ylabel('Mean Current Density')
title('Relationship between Mean Current Density and Contact Conductivity')